...
public class DashboardSecurity extends JFrame {

    private static final java.util.logging.Logger logger =
            java.util.logging.Logger.getLogger(DashboardSecurity.class.getName());
    ...
    private JPanel createSidebarPanel() {
        ...
        sidebar.add(createNavigationButton(PAGE_REPORTS, "Laporan Temuan", "icon_file.png"), gbc);
    ...
    private JPanel createUserCard() {
        ...
        gbc.gridy = 0;
        card.add(UserDashboardComponents.label("SECURITY", 10, Font.BOLD, UserDashboardComponents.TEXT_MUTED), gbc);
    ...
    private void showPage(String pageKey) {
        if (PAGE_FOUND_ITEMS.equals(pageKey) || PAGE_LOST_ITEMS.equals(pageKey) || PAGE_STORAGE.equals(pageKey)) {
    ...
    private String getUserDetail() {
        if (currentUser instanceof Security) {
            Security s = (Security) currentUser;
            return s.getSecurityID() != null && !s.getSecurityID().isBlank() ? "ID: " + s.getSecurityID() : "SECURITY";
        }
